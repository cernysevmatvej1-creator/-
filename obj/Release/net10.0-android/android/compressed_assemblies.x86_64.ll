...
@compressed_assembly_descriptors = dso_local local_unnamed_addr global [141 x %struct.CompressedAssemblyDescriptor] [
	...
	%struct.CompressedAssemblyDescriptor {
		i32 2232832, ; uint32_t uncompressed_file_size
		i1 false, ; bool loaded
	...
	%struct.CompressedAssemblyDescriptor {
		...
		i1 false, ; bool loaded
		i32 15973528; uint32_t buffer_offset
	}, ; 138: Java.Interop
	%struct.CompressedAssemblyDescriptor {
		i32 22560, ; uint32_t uncompressed_file_size
		i1 false, ; bool loaded
		i32 16144536; uint32_t buffer_offset
	}, ; 139: Mono.Android.Runtime
	%struct.CompressedAssemblyDescriptor {
		i32 2022912, ; uint32_t uncompressed_file_size
		i1 false, ; bool loaded
		i32 16167096; uint32_t buffer_offset
	} ; 140: Mono.Android
], align 16

@uncompressed_assemblies_data_size = dso_local local_unnamed_addr constant i32 18190008, align 4

@uncompressed_assemblies_data_buffer = dso_local local_unnamed_addr global [18190008 x i8] zeroinitializer, align 16
